...
<jsp:include page="include/sidebar.jsp"></jsp:include>
  ...
  <div class="box">
            ...
            <div class="box-header">
              <h3 class="box-title">Marquee Booking Details</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
          	...
          	String d = sdf.format(date);
                ...
                <tr>
                  <td><%=serialNo%></td>
                    ...
                    <td><%=m.getAddress() %></td>
                    <td><%=m.getContact() %></td> 
                    <td><a href="booking-detail.jsp?id=<%=m.getId()%>Mb<%=d.replaceAll("\\s", "")%>Ne3Gj3I7"><input type="image" id="image" src="img/detail.png" /></a></td>   
                </tr>
                <%} %>
                </tbody>
                <tfoot>
