...
setTimeout(
  ...
  function disApproved(){ 
      $.ajax({
        url : '../Marquee' ,
        data : "id="+id+"&method=disApproved&type=disApproved" ,
        type : 'post' ,
	...
	<div class="modal-dialog modal-confirm">
		<div class="modal-content">
			<div class="modal-header"> 
				...
				<h4 class="modal-title">Are you sure? To DisApprove This Marquee</h4>	
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-danger" onclick="disApproved();" data-dismiss="modal" id="rejectBtn">DisApprove...?</button>
		</div>
	</div>
</div> 
</center>    
...
<jsp:include page="include/sidebar.jsp"></jsp:include>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
		...
		<div class="alert alert-danger alert-dismissible"  style="display: none" id="Dataupdate" >
  ...
  <div class="box">
            ...
            <div class="box-header">
              <h3 class="box-title">Approved Marquee</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
          ...
          String d = sdf.format(date);
                ...
                <tr>
                  <td><%=serialNo%></td>
                    ...
                    <td><%=m.getAddress() %></td>
                    <td><%=m.getContact() %></td>
                    <td><a href="#myModal" class="trigger-btn" data-toggle="modal"><input type="image" id="image" src="img/cancel.png" onclick="getID(<%=m.getId() %>)" value="<%=m.getId() %>" /></a>
