<%@page import="com.easybooking.model.Footer"%>
<%@page import="com.easybooking.daoImp.FooterDaoImp"%>
<%@page import="com.easybooking.dao.FooterDao"%>
      ...
      $.ajax({
          ...
          success : function (data){
              ...
              $('#id').val(obj.id);   
				...
				$('#image').attr("src","/EasyBooking/img/footer-img/"+obj.logo);
				$('#img_name').val(obj.logo); 
    ...
    <section class="content-header">
     ...
     <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add Footer Data</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form id="formID" enctype="multipart/form-data" onsubmit="" >
              <div class="box-body">
              ...
              <input type="hidden" name="id" id="id"/>  
                  ...
                  <input type="number" id="phone" class="form-control"  placeholder="Enter Phone (Allow only Numbers)" name="phone" required="required" />
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="file" id="logo" class="form-control"  placeholder=""  name="logo"  />
                  <input type="hidden" name="img_name" id="img_name" >
                    	<img id="image" height="15%" width="35%" style="display: none"/>
              ...
              <div class="box-footer"> 
                <input type="submit" id = "submit" name="submit" value="Update Footer Data" class="btn btn-primary"  disabled/>
              </div>
            </form>
          </div>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                for(Footer f : footerDao.getFooterData()){ serial++;%>
                	<tr>
                		<td><%=serial%></td>  
                		<td><img src="/EasyBooking/img/footer-img/<%=f.getLogo()%>" height="15%" width="100%"></td>
                		<td><%=f.getPhone()%></td>
                		<td><%=f.getEmail()%></td>
                		<td><%=f.getAddress()%></td>
                		<td><%=f.getMessage()%></td>
