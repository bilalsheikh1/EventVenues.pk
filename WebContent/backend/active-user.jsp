            ...
            String d = sdf.format(date);
                ...
                <tr> 
                  <td><%=serialNo%></td>
                    ...
                    <td><%=u.getEmail() %></td>
                    <td><%=u.getContact() %></td>
                    <td><a href="add-user.jsp?id=<%=u.getId()%>Mb<%=d.replaceAll("\\s", "")%>Ha3g7"><!--  <input type="image" src="img/updateicon.png">--></a>
                      <input type="image" id="image" src="img/deleteicon.png" onclick="deleterecord(<%=u.getId() %>)" value="<%=u.getId() %>" />
                    </td>
                </tr>
                <%} %>
                </tbody>
