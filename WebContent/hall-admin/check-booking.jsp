...
function closeAlert(){
	setTimeout(
			  function() 
			  {
				  $("#Datacancel").css("display","none");
			  }, 3000) }
var id = 0;
var requestID = 0;

function getID(id ,requestID){
	this.id = id;
  ...
  function cancelRequest(){ 
          $.ajax({ 
              url : '../BookingServlet' , 
              data : 'method=delete&id='+id+"&requestID="+requestID,   
              type : 'post',
	...
	<div class="modal-dialog modal-confirm">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-danger" onclick="cancelRequest();" data-dismiss="modal" id="rejectBtn">Cancel Booking</button>
		</div>
	</div>
</div> 
</center>    
...
<jsp:include page="include/sidebar.jsp"></jsp:include>
  ...
  <div class="content-wrapper">
    ...
    <div class="alert alert-danger alert-dismissible"  style="display: none" id="Datacancel" >
      ...
      <div class="box">
           <form id="formFilter" onsubmit="return dataFilter();" >
            <div class="box-header">
              <h3 class="box-title">Filter</h3>
            </div>
            <input type="hidden" name="filter" value="dataFilter" />
            ...
            String d = sdf.format(date);
                ...
                <tr>   
                  ...
                  <td><%=userName%></td> 
                    ...
                    <td> 
                      <a href="#myModal" class="trigger-btn" data-toggle="modal"><input type="image" id="image" src="../backend/img/deleteicon.png" onclick="getID(<%=b.getId() %> , <%=b.getBookingRequest().getId()%>)" value="<%=b.getId() %>" /></a>
